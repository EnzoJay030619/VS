...
h1 {
	font: bold italic normal 3em Baskerville, "Palatino Linotype", "Times New Roman", serif;
...
.subform input[type="text"], input[type="password"], input[type="number"],input[type="email"],.subform textarea {
  border-radius: 5px;
  border: none;
...
.subform input[type="text"]:focus,input[type="number"]:focus, input[type="password"]:focus,input[type="email"]:focus,.subform textarea:focus {
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            @endif
                ...
                <div>
                    ...
                    <img src="{{asset('images/artix.jpg')}}" alt=""></a>
                </div>
